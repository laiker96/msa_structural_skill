#!/usr/bin/env python3
"""Legacy wrapper for structural-evolution Aggrescan3D scoring."""
...
TARGET = ROOT / "scripts" / "structural_evo_analysis" / "structure_score_aggrescan3d.py"
DEFAULT_QUERY_PDB = (
    ROOT
    / "results"
    / "structural"
...
def main() -> None:
    ...
    add_default(("--out-dir",), ROOT / "results" / "msa_OGT" / "structure_scores" / "aggrescan3d")
