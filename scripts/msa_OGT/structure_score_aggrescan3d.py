#!/usr/bin/env python3
"""MSA pipeline Aggrescan3D scoring for ANKros and AFDB structures."""
...
DEFAULT_OUT_DIR = ROOT / "results" / "msa_OGT" / "structure_scores" / "aggrescan3d"
...
Generated by `scripts/msa_OGT/structure_score_aggrescan3d.py`.
